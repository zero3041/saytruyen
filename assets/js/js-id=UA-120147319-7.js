...
(function() {
	...
	var data = {
		"resource": {
			...
			"predicates": [{
				"function": "_eq",
				"arg0": ["macro", 0],
				"arg1": "gtm.js" /*tpa=https://www.googletagmanager.com/gtag/gtm.js*/
			}],
			"rules": [
				[
					["if", 0],
	...
	*/
	...
	var P = {
		...
		Qc: "event_timeout",
		xa: "gtag.config",
		Ja: "https://www.googletagmanager.com/gtag/gtag.get",
		va: "purchase",
		Gb: "refund",
		ib: "begin_checkout",
		Eb: "add_to_cart",
	...
	S.ed = "ba1";
	S.U = "dataLayer";
	S.$g = "ChEIgKiCjQYQ9feF9Ivow8WSARInAFZHboBKVarP39ycFDNmddh6n3oVISHxtV+QERU0JP7xbUGuvO9LGgLxPA\x3d\x3d";
	var Gd = {
			__cl: !0,
			__ecl: !0,
			__ehl: !0,
	...
	S.Dd = "https://www.googletagmanager.com/gtag/www.googletagmanager.com";
	var Jd = S.Dd + "/gtm.js";
	Jd = S.Dd + "/gtag/js";
	var Kd = Jd,
		Ld = Ha(""),
			...
			if (void 0 !== a && a.match(hi)) switch (b) {
				case void 0:
					f(a,
						"aw");
					break;
				case "https://www.googletagmanager.com/gtag/aw.ds":
					f(a, "aw");
					f(a, "dc");
					break;
				case "ds":
					f(a, "dc");
					break;
				case "https://www.googletagmanager.com/gtag/3p.ds":
					f(a, "dc");
					break;
				case "gf":
					f(a, "gf");
	...
	var Ik = !1,
		Ok = function(a) {
			var b = m(),
				...
				d = a.event;
			if ("gtm.js" /*tpa=https://www.googletagmanager.com/gtag/gtm.js*/ === d) {
				if (Ik) return !1;
				Ik = !0;
			}
			var g = ve(c),
				l = !1;
			if (!g.active) {
				if ("gtm.js" /*tpa=https://www.googletagmanager.com/gtag/gtm.js*/ !== d) return !1;
				l = !0;
			...
			l && (v = Mk(v));
			var t = Hk(v, r);
			"gtm.js" /*tpa=https://www.googletagmanager.com/gtag/gtm.js*/ !== d && "https://www.googletagmanager.com/gtag/gtm.sync" !== d || xj(S.J);
			return Nk(v, t)
		};
	...
	var bm = function(a, b, c) {
		...
		cm = {
			...
			ud: "_googWcmAk",
			Te: "loader.js" /*tpa=https://www.googletagmanager.com/gtag/www.gstatic.com/wcm/loader.js*/
		},
		dm = {
			functionName: "_gaPhoneImpl",
			ud: "ga_wpid",
			Te: "loader-1.js" /*tpa=https://www.googletagmanager.com/gtag/www.gstatic.com/gaphone/loader.js*/
		},
		em = {
			Wg: "",
			Th: "5"
		...
		Ln = function(a, b, c) {
			...
			if (sa(l)) {
				...
				var p = function(J) {
					...
					r = function(J) {
						...
						if (I) {
							var K = {};
							Cn(K, J);
							p("require", "ec", "ec.js" /*tpa=https://www.googletagmanager.com/gtag/ec.js*/ , K);
				...
				if (q.Aa[P.mb] && !c.isGtmEvent) {
					var x = Qk(q.Aa[P.mb], "analytics.js" /*tpa=https://www.googletagmanager.com/analytics.js*/ );
					x && (g = x)
				}
				...
				c.isGtmEvent ? q.enableRecaptcha && p("require", "recaptcha", "recaptcha.js" /*tpa=https://www.googletagmanager.com/gtag/recaptcha.js*/ ) : (d(), v(q.linkAttribution));
				var y = q[P.ia];
				y && y[P.N] && xn(y, n);
				p("set", q.sc);
				if (c.isGtmEvent) {
					if (q.enableLinkId) {
						var A = {};
						p("require", "linkid", "linkid.js" /*tpa=https://www.googletagmanager.com/gtag/linkid.js*/ , A)
					}
					Ne() && Bn(f, n, c)
				}
				if (b === P.Zb)
					...
					!0), u("eventAction", q.eventAction || b, !0), void 0 !== q.eventLabel && u("eventLabel", q.eventLabel, !0), void 0 !== q.value && u("eventValue", Ea(q.value))), p("send", q.ka));
				var F = !1;
				var D = Kn;
	...
	var Mo = {
			...
			js: function(a) {
				if (2 == a.length && a[1].getTime) {
					...
					Lo();
					var b = {};
					return b.event = "gtm.js" /*tpa=https://www.googletagmanager.com/gtag/gtm.js*/ , b["gtm.start"] = a[1].getTime(),
		...
		for (var a = !1; !mp && 0 < kp.length;) {
			if (!lp && qp()) {
				var b = {},
					...
					d = {},
					e = (d.event = "https://www.googletagmanager.com/gtag/gtm.init", d),
	...
	var up = function() {
			...
			ej(function() {
				b.gtmDom || (b.gtmDom = !0, a.push({
					event: "https://www.googletagmanager.com/gtag/gtm.dom"
				}))
			});
			To(function() {
				b.gtmLoad || (b.gtmLoad = !0, a.push({
					event: "https://www.googletagmanager.com/gtag/gtm.load"
				}))
			});
	...
	(function(a) {
		...
		if (!g && G.referrer) {
			var k = og(G.referrer);
			"https://www.googletagmanager.com/gtag/tagassistant.google.com" === lg(k, "host") && (g = 3)
		}
		if (!g) {
